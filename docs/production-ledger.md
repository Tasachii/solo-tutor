...
| J-11 | RPC อ่านเอกสารแบบไม่ต้องเข้าสู่ระบบ ยังไม่มีตัวจำกัดอัตรา | `0011_shared_documents.sql` | ต้องมี rate limit ก่อนเปิดใช้จริงในวงกว้าง | **ยังไม่ทำ** | เดา token 122 บิตไม่ไหว แต่ไม่มีอะไรกันการยิงถี่ · ตัวจำกัดเดิมทำงานผ่าน edge function เท่านั้น |
