...
- **ค้างจ่าย** — บิลค้างทุกใบเรียงตามวันค้าง แสดงขั้นทวง (สุภาพ/ชัดเจน/ครั้งสุดท้าย) ร่างที่รอส่ง ทวงล่าสุด และสถานะเชื่อม OA ของผู้ปกครองแต่ละคน · ปุ่ม **ส่งทวงทั้งหมดผ่าน LINE OA (n)** ส่งทีละใบตามลำดับที่เห็น ข้ามผู้ปกครองที่ยังไม่เชื่อมและบอกเหตุผล ครูเห็นข้อความทุกใบในรายการก่อนกด (หลักการ "ครูกดส่ง" ยังอยู่ — กดหนึ่งครั้งต่อชุดที่ตรวจแล้ว) · **ทวงสั้น** สร้างข้อความเตือนยอดวันละใบต่อบิลเข้าคิว
- **การบ้าน** — มอบหมายให้หลายคนพร้อมกันพร้อมกำหนดส่ง ระบบร่างข้อความแจ้งผู้ปกครอง เมื่อเลยกำหนดและยังไม่ทำเครื่องหมาย "ได้รับแล้ว" ระบบร่างข้อความทวงให้เอง ทวงซ้ำได้วันละใบ ทำเครื่องหมายได้รับแล้วร่างทวงถอนตัวเอง
